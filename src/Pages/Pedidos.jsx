...
const Pedidos = () => {
    ...
    React.useEffect(() => {
        ...
        const url = "http://learnphp/fseletro/src/backend/ped.php";
    ...
    function newOrder(event) {
        ...
        const url = "http://learnphp/fseletro/src/backend/neworder.php";
    ...
    return (
        ...
        <form className="form-group" onSubmit={newOrder}>
            <h1 className="efeito2">Faça seu Pedido e Aproveite Promoções:</h1><br /> 
            <div className="form-group">
            <label for="cliente">Cliente:</label>               
            <input className="form-control" name="cliente" type="text" required />
            </div>
            <div className="form-group">
            ...
            <input className="form-control" type="tel" name="tel" placeholder=" Formato: 00-00000-0000" pattern="[0-9]{2}-[0-9]{5}-[0-9]{4}" required />
           </div>
           ...
           <div className="form-group">
            ...
            <input className="form-control" type="number" id="preco" name="preco" required />
            </div>
            <div className="form-group">
            <label for="qtd">Quantidade:</label>
            
            <input className="form-control" type="number" id="qtd" name="qtd" required />
            </div>
            <div className="form-group">
            <label for="total">Valor Total:</label>
           
            <input className="form-control" type="number" id="total" name="total" required />
            </div>
            <br />
            <button type="submit" className="btn btn-primary col-md-6 offset-md-3" name="submit">Enviar</button>
            <br />
            <br />
        </form>
        {msg &&
                ...
                <Card color="#0F4D92" key={element.id} titulo={element.cliente}>
                     <p> <b>Data: </b>{element.dia}</p>                      
                     <p><b>Endereço:</b> {element.endereco} </p>
                     <p><b>Telefone:</b> {element.telefone} </p>
                     <p><b>Produto:</b> {element.produto} </p>
                     <p><b>Preço:</b> {element.preco} </p>
                     <p><b>Quantidade:</b> {element.quantidade} </p>
                     <p><b>Valor Total:</b> {element.preco_total} </p> 
